...
void TranEntry::TranEntryInit()
{
    ...
    mNumSQLTries = 3;	// will be increased later by the SOS constructor.
	mContext = NULL;
	//mChannel = NULL;
	//mNextChannel = NULL;
	mMMData = NULL;
...
void CdrService::cdrOpenFile()
{
    ...
    string btsid = "127.0.0.1";	// Default bts id to the local IP address.

...
public:
	...
	//L3NetworkName(const char* wName, GSMAlphabet alphabet=ALPHABET_7BIT, int wCI=gConfig.getBool("GSM.ShowCountry"))
    L3NetworkName(const char* wName, GSMAlphabet alphabet=ALPHABET_7BIT, int wCI=false)

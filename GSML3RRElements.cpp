...
//	mT3212=gConfig.getNum("GSM.Timer.T3212")/6;
    mBS_PA_MFRMS = 2;	// Number of paging multiframes.  Default is 2, the minimum allowed value.
    // Configurable values.
    mATT=(unsigned)true;
    mT3212=0/6; // FIXME: This being 0 doesn't seem correct.
}

...
{
    // FIXME: Bypassing the dumb config system...
	//return gConfig.getNum(SQL_MULTISLOTMAXDOWNLINK) > 1 || gConfig.getNum(SQL_MULTISLOTMAXUPLINK) > 1;
    //  "GPRS.Multislot.Max.Downlink"   "GPRS.Multislot.Max.Uplink"
    return 3 > 1 || 2 > 1;
}

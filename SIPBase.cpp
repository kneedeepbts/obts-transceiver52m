...
void DialogStateVars::updateProxy(const char *sqlOption)
{
	...
	//string proxy = gConfig.getStr(sqlOption); // "SIP.Proxy.Registration"
    string proxy = "127.0.0.1:5064";
...
string OpenBTSUserAgent()
{
    ...
    // FIXME: Bypassing the dumb config.h file
	//static const char* userAgent1 = "OpenBTS " VERSION " Build Date " TIMESTAMP_ISO;
    static const char* userAgent1 = "OpenBTS BAD_VERSION Build Date TIMESTAMP_ISO";

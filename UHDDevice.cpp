...
// FIXME: Need to check on what this is used for, as the `msg.hpp` header file
//        no longer exists (and hasn't for a while).
 ...
 */
// FIXME: Bypassing this for now, since it just seems to be logging and uses the
//        `msg.hpp` header file that no longer exists.
...
bool uhd_device::start() {
    ...
    // FIXME: Bypassing this for now, since it just seems to be logging and uses
    //        the `msg.hpp` header file that no longer exists.
